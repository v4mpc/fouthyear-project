...
<div class="panel-group"><div class="panel panel-default"><div class="panel-heading">Security</div><div class="panel-body"><form>
...
if ($hasEdit==1) {
    ...
    if($employerInfos->num_rows()>0){
      ...
      /*  $employerinfos_html.='<p>Company Name: <b>'.$companyname.'</b></p>';
        $employerinfos_html.='<p>Email: <b>'.$emailE.'</b></p>';
        $employerinfos_html.='<p>User Name: <b>'.$username.'</b></p>';
        $employerinfos_html.='<p>Region: <b>'.$regionE.'</b></p>';
        $employerinfos_html.='<p>District: <b>'.$districtE.'</b></p>';
        $employerinfos_html.='<p>Founded: <b>'.$founded.'</b></p>';
        $employerinfos_html.='<p>Website: <b>'.$website.'</b></p>';
        $employerinfos_html.='<p>Size: <b>'.$size.'</b></p>';*/
